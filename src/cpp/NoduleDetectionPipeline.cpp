...
{
    std::ifstream fileage(_metadataFileName, std::ios_base::openmode mode = std::ios_base::in); // declare file stream: http://www.cplusplus.com/reference/iostream/ifstream/
    std::string value;
